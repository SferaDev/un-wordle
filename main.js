this.wordle = this.wordle || {},
    this.wordle.bundle = function (e) {
            ...
            , ts = function (e) {
                ...
                function t() {
                    ...
                    return e.lastPlayedTs = o.lastPlayedTs,
                        !e.lastPlayedTs || o.gameStatus !== "IN_PROGRESS" ? (e.boardState = new Array(6).fill(""),
      ...
      ***************************************************************************** */
        ...
        var Is = document.createElement("template");
        Is.innerHTML = '<div style=" display: flex; width: 50%; place-content: center; "><button id="retry-button" onclick="window.location.reload();"> Play again </button></div>';
        var Ms = {
                ...
                return o(t, [{
                    ...
                    value: function () {
                        ...
                        if (["gamesPlayed", "winPercentage", "currentStreak", "maxStreak"].forEach((function (s) {
                            ...
                            p.appendChild(m),
                                this.shadowRoot.querySelector("button#retry-button").addEventListener("click", (function (a) {
                                    a.preventDefault(),
                                        a.stopPropagation();
                                    As(function (e) {
                                        var a = e.evaluations
